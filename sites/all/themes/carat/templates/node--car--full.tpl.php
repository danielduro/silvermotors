...
?>
<div
     class="node-car-full <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="block block-padding block-margin background-white block-shadow">
            <?php print render($content['field_resellet_position']); ?>
          </div>
        ...
        <div class="col-md-6">
          ...
          hide($content['field_resellet_position']);
